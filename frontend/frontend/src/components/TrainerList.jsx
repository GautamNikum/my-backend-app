          ...
          {trainers.map((trainer) => (
            <tr key={trainer._id}>
              ...
              <td style={{display:"flex", justifyContent:"space-evenly"}}>
                <button onClick={() => handleEdit(trainer)} style={{backgroundColor:"royalblue" ,marginRight:"10px", marginLeft:"10px"}} >  Edit</button>
                <button onClick={() => deleteTrainer(trainer._id)} style={{backgroundColor:"crimson"}}>Delete</button>
